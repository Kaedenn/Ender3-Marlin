...
#define STRING_CONFIG_H_AUTHOR "(Kaedenn A. D. N, Ender-3 V4.2.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "(K) Ender-3 4.2.2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -6, -1.40 }
